...
const SUBINDEX_PURPOSE = {
  ...
  11:  ['Task helpers', 'Routines that queue tasks for characters: the innkeeper’s service lines (0xC80), opening and closing doors (0xC81–0xC83), the tavern barks (0xC84, 0xC85), the blacksmith’s work (0xC86), and the spell-cast announcements (0xC4B, 0xC4C).'],
  ...
  13:  ['Rule helpers', 'The routines the rules are read from: lock picking (0xE43), combat (0xE84–0xE89), experience and levels (0xE86, 0xE8B), spells (0xEA1), shops (0xEA5), training (0xEB1), damage (0xEB8).'],
  14:  ['Character helpers', 'Twenty-two one-function scripts, each acting on one character: set, clear and test a flag (0xF00–0xF02, called from hundreds of dialogue lines), behaviour, health, poison, attributes, experience, level, karma, and two constructors.'],
