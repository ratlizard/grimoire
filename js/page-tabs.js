...
const SUBINDEX_PURPOSE = {
  ...
  1:   ['Data lists and the game’s writing', 'Lists of things: character names, and the global values the symbol table in subindex 0 names. It is also where Cythera’s own writing lives: the bookshelf histories and bestiaries, the prophecies, the scrolls and letters, the signs, the gravestones and the ring inscriptions. Each passage is one entry in a list, and a thing in the world picks its entry with the number in its Data1. The Mechanics sheet reads them under The game’s own writing.'],
  2:   ['Global store', '0x301 holds four values any script can read and write, the quality of each inn. 0x33F is four bytes nothing uses.'],
  ...
  16:  ['Object classes', 'Objects with data and scripts of their own, and text in them you can read.'],
  19:  ['Zone entry scripts', 'One for each map. It runs as you enter the zone, and carries the zone names the game shows.'],
